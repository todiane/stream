...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('icon', models.CharField(choices=[('book', 'Book'), ('pencil', 'Pencil'), ('star', 'Star'), ('certificate', 'Certificate'), ('lightbulb', 'Lightbulb'), ('laptop', 'Laptop'), ('people-fill', 'People'), ('award', 'Award'), ('journal-text', 'Journal')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', tinymce.models.HTMLField(help_text='Introduction paragraph about yourself')),
                ('is_active', models.BooleanField(default=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('second_content', tinymce.models.HTMLField(blank=True, null=True)),
                ('third_content', tinymce.models.HTMLField(blank=True, null=True)),
            ],
            options={
                'ordering': ['title'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.ImageField(blank=True, null=True, storage=stream.storage.PublicMediaStorage(), upload_to='testimonials/images/')),
                ('external_image_url', models.URLField(blank=True, help_text='External URL for testimonial image (jpg/png only)', max_length=500, null=True)),
                ('order', models.PositiveIntegerField(default=0)),
                ('is_active', models.BooleanField(default=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('icon', models.CharField(choices=[('book', 'Book'), ('pencil', 'Pencil'), ('star', 'Star'), ('certificate', 'Certificate'), ('lightbulb', 'Lightbulb'), ('laptop', 'Laptop'), ('people-fill', 'People')], max_length=20)),
                ('title', models.CharField(max_length=200)),
                ('description', models.TextField()),
                ('size', models.CharField(choices=[('small', 'Small'), ('large', 'Large')], max_length=10)),
                ('order', models.PositiveIntegerField(default=0)),
