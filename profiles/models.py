...
class Profile(models.Model):
    ...
    enrolled_courses = models.ManyToManyField(
        "courses.Course", blank=True, related_name="enrolled_students"
    )
    watched_videos = models.ManyToManyField(
        "courses.Lesson", blank=True, related_name="watched_by"
    )
    ...
    purchased_products = models.ManyToManyField(
        "shop.Product", blank=True, related_name="purchasers"
    )
    ...
    def get_courses_completion_percentage(self):
        ...
        total_progress = sum(
            self.get_course_completion_percentage(course) for course in enrolled_courses
        )
